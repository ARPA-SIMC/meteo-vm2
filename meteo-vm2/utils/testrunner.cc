...
using namespace std;
using namespace meteo::vm2::utils;
...
SimpleTestController::SimpleTestController(meteo::vm2::utils::term::Terminal& output)
    : output(output)
{
}
...
VerboseTestController::VerboseTestController(meteo::vm2::utils::term::Terminal& output)
    : output(output) {}
...
struct Title
{
    meteo::vm2::utils::term::Terminal& output;
    std::string title;
    bool printed = false;

    Title(meteo::vm2::utils::term::Terminal& output, const std::string& title)
...
void TestResultStats::print_results(meteo::vm2::utils::term::Terminal& out)
{
...
void TestResultStats::print_stats(meteo::vm2::utils::term::Terminal& out)
{
...
void TestResultStats::print_summary(meteo::vm2::utils::term::Terminal& out)
{
