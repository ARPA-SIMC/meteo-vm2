#ifndef METEO_VM2_UTILS_TESTSRUNNER_H
#define METEO_VM2_UTILS_TESTSRUNNER_H
...
struct SimpleTestController : public FilteringTestController
{
    ...
    SimpleTestController(meteo::vm2::utils::term::Terminal& output);
...
struct VerboseTestController : public FilteringTestController
{
    ...
    VerboseTestController(meteo::vm2::utils::term::Terminal& output);
...
struct TestResultStats
{
    ...
    void print_results(meteo::vm2::utils::term::Terminal& out);
    void print_stats(meteo::vm2::utils::term::Terminal& out);
    void print_summary(meteo::vm2::utils::term::Terminal& out);
};
