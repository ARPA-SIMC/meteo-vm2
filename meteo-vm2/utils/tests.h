#ifndef METEO_VM2_UTILS_TESTS_H
#define METEO_VM2_UTILS_TESTS_H
 ...
 */
extern const meteo::vm2::utils::tests::LocationInfo meteo_vm2_utils_test_location_info;
 ...
 * test_function(...)
 * {
 *    METEO_VM2_UTILS_TEST_INFO(info);
 ...
 */
#define METEO_VM2_UTILS_TEST_INFO(name) \
    meteo::vm2::utils::tests::LocationInfo meteo_vm2_utils_test_location_info; \
    meteo::vm2::utils::tests::LocationInfo& name = meteo_vm2_utils_test_location_info
...
#define wassert(...) \
    do { try { \
        __VA_ARGS__ ; \
    } catch (meteo::vm2::utils::tests::TestFailed& e) { \
        e.add_stack_info(__FILE__, __LINE__, #__VA_ARGS__, meteo_vm2_utils_test_location_info); \
        throw; \
    } catch (std::exception& e) { \
        throw meteo::vm2::utils::tests::TestFailed(e, __FILE__, __LINE__, #__VA_ARGS__, meteo_vm2_utils_test_location_info); \
    } } while(0)
...
#define wcallchecked(func) \
    [&]() { try { \
        ...
        e.add_stack_info(__FILE__, __LINE__, #func, meteo_vm2_utils_test_location_info); \
        throw; \
    } catch (std::exception& e) { \
        throw meteo::vm2::utils::tests::TestFailed(e, __FILE__, __LINE__, #func, meteo_vm2_utils_test_location_info); \
    } }()

/**
 * Fail a test with an error message
 */
#define wfail_test(msg) wassert(throw meteo::vm2::utils::tests::TestFailed((msg)))
